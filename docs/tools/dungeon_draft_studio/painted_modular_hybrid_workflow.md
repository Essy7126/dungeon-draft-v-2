...
- **Créer une working copy HYBRIDE — recommandé** : conserve le fond, crée le profil si nécessaire, choisit NON_BASE_TERRAINS/base stone et enregistre une seule action Undo ;
...
Le background reste visible. NONE n'ajoute aucun sol ; NON_BASE_TERRAINS rend uniquement les overlays différents du terrain de base ; ALL_DEFINED rend toutes les dalles définies. La conversion recommandée de la forêt utilise NON_BASE_TERRAINS afin que water, ice et lava soient visibles sans recouvrir tout le décor peint.

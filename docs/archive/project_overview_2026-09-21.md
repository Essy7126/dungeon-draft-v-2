# Archive — présentation du projet avant clarification du 21 septembre 2026

Instantané historique conservé pour ses références. Pour le produit actuel, lire [la référence courante](../current/product.md). Les validations mentionnées ci-dessous ne sont pas des preuves fraîches.

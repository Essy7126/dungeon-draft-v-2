...
const ROOM := "res://data/rooms/catabase_routes/route_76ac69bb7c8d/room.tres"
const BASELINE := "res://artifacts/dev/puits-descent/before/room.tres"
const PROFILE := "res://assets/catabase/combat/puits_descent_v1/presentation.tres"
const MANIFEST := "res://assets/catabase/combat/puits_descent_v1/manifest.json"
...
func _ready() -> void:
	...
	profile.profile_id = &"puits_descent_v1"
	...
	output.close()
	print("PUITS_DESCENT_PREPARED: ", JSON.stringify({ "ok": true, "gameplay": expected }))
	get_tree().quit(0)

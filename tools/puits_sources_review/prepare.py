"""Calibrate art against La garde des sources geometry, never infer gameplay from pixels."""
import hashlib
import json
...
ROOM = ROOT / 'data/rooms/catabase_routes/route_9c104c2158d3'
OUT = ROOT / 'assets/catabase/combat/puits_sources_v1'
BASE = ROOT / 'artifacts/dev/puits-sources/before'

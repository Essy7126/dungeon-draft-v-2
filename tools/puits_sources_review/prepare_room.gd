...
const ROOM := "res://data/rooms/catabase_routes/route_9c104c2158d3/room.tres"
const BASELINE := "res://artifacts/dev/puits-sources/before/room.tres"
const PROFILE := "res://assets/catabase/combat/puits_sources_v1/presentation.tres"
const MANIFEST := "res://assets/catabase/combat/puits_sources_v1/manifest.json"
...
func _ready() -> void:
	...
	profile.profile_id = &"puits_sources_v1"
	...
	output.close()
	print("PUITS_SOURCES_PREPARED: ", JSON.stringify({ "ok": true, "gameplay": expected }))
	get_tree().quit(0)

...
const ROOM := "res://data/rooms/catabase_routes/route_10ce1ff88330/room.tres"
const BASELINE := "res://artifacts/dev/lethe-lances/before/room.tres"
const PROFILE := "res://assets/catabase/combat/lethe_lances_v1/presentation.tres"
const MANIFEST := "res://assets/catabase/combat/lethe_lances_v1/manifest.json"
...
func _ready() -> void:
	...
	profile.profile_id = &"lethe_lances_v1"
	profile.camera_zoom_multiplier = 1.0
	profile.camera_offset_adjustment = Vector2(-120, -30)
	...
	output.close()
	print("LETHE_LANCES_PREPARED: ", JSON.stringify({ "ok": true, "gameplay": expected }))
	get_tree().quit(0)

"""Calibrate art against Le gué des serments geometry, never infer gameplay from pixels."""
import hashlib
import json
...
ROOM = ROOT / 'data/rooms/catabase_routes/route_1c7d4c943b3a'
OUT = ROOT / 'assets/catabase/combat/gue_serments_v1'
BASE = ROOT / 'artifacts/dev/gue-serments/before'
...
def main():
    ...
    data={'canvas_size':[1920,1200],'allowed_floor_polygon':reserve,
          ...
          'legend':'Green cells: engine floor. Red/purple/orange/blue: engine-owned spawns/props. Paint ALL reserve flat, without tiles or props. Upper left rectangle: arrival arch from previous room, outside combat. Water only outside the gray bank.'}

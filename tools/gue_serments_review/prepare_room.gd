...
const ROOM := "res://data/rooms/catabase_routes/route_1c7d4c943b3a/room.tres"
const BASELINE := "res://artifacts/dev/gue-serments/before/room.tres"
const PROFILE := "res://assets/catabase/combat/gue_serments_v1/presentation.tres"
const MANIFEST := "res://assets/catabase/combat/gue_serments_v1/manifest.json"
...
func _ready() -> void:
	...
	profile.profile_id = &"gue_serments_v1"
	...
	output.close()
	print("GUE_SERMENTS_PREPARED: ", JSON.stringify({ "ok": true, "gameplay": expected }))
	get_tree().quit(0)

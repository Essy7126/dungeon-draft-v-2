...
const VEIL := preload("res://vfx/class_cards/ethereal/veil.gdshader")
const FIRE := preload("res://vfx/class_cards/ethereal/fire.gdshader")
const SMOKE := preload("res://vfx/class_cards/ethereal/smoke.gdshader")
const WHITE := preload("res://vfx/class_cards/ethereal/white.tres")
const NOISE := preload("res://vfx/class_cards/ethereal/flow_noise.tres")
const PILOT := preload("res://vfx/class_cards/ethereal/pilot.gdshader")
const SPELL := preload("res://vfx/class_cards/ethereal/spell.gdshader")
const POWER := preload("res://vfx/class_cards/ethereal/power.gdshader")
const Power := preload("res://vfx/class_cards/class_card_vfx_power.gd")
const Concepts := preload("res://vfx/class_cards/class_card_vfx_concepts.gd")

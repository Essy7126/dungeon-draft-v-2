...
static func production_scenarios() -> Array[UISnapshotScenario]:
	return [
		...
		Scenario.new(&"pause_menu", &"default", "res://ui/menus/DarkPauseMenu.tscn", &"combat_mode", &"documented", &"production", "La pause globale modifierait SceneTree pendant une capture groupée."),
		...
		Scenario.new(&"post_combat", &"equipment_reward", "res://ui/post_combat/EquipmentRewardOverlay.tscn", &"reward_three_cards", &"documented", &"production", "Déjà couvert par tools/labs/equipment_reward ; consolidation différée pour ne pas dupliquer la fixture."),

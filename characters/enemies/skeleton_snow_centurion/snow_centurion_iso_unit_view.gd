class_name SnowCenturionIsoUnitView
extends CharacterIsoUnitView


func get_snow_centurion_visual() -> SnowCenturionVisual3D:
	return get_character_visual() as SnowCenturionVisual3D
...
func play_hit() -> bool:
	...
	return _play_if_new(
		...
		VisualPriority.HIT,
		SnowCenturionVisual3D.HIT_SPEED
	)
...
func play_death() -> bool:
	...
	return _play_if_new(
		...
		SnowCenturionVisual3D.DEATH_SPEED
	)

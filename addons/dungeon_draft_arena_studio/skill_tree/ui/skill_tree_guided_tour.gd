...
const CHAPTERS := [
	[&"start", "1 · Bien démarrer", [
		...
		[&"guided_advanced", "Mode guidé et mode avancé", &"mode_toggles", "Le [b]Mode guidé[/b] montre explications et champs essentiels. Désactivez-le pour voir les réglages techniques. [b]Comment fonctionne cet effet ?[/b] explique toujours le résultat sans modifier les données."],
		...
		[&"shortcuts", "Raccourcis utiles", &"toolbar", "[b]Ctrl+F[/b] recherche ; [b]Ctrl+S[/b] revoit puis sauvegarde ; [b]Ctrl+Z/Y[/b] gère l’historique. Le menu [b]Outils[/b] regroupe prévisualisation, analyse, comparaison, fiche générale et Resources orphelines. Dans le graphe, [b]Ctrl+C/V/D[/b] copie, colle ou duplique, et [b]Échap[/b] annule une liaison en cours."],
	]],
	...
	[&"discipline", "3 · Discipline et XP", [
		...
		[&"production_contract", "Vérifier le modèle 5 rangs", &"mode_toggles", "En mode avancé, ce contrôle facultatif attend cinq rangs, 0/2/4/8/4 choix et seize configurations finales. Une autre topologie reste autorisée et produit seulement des avertissements."],
	]],
	...
	[&"effects", "6 · Effets (33)", [
		...
		[&"legacy_modifiers", "Modificateurs historiques", &"inspector_effect_advanced", "Treize classes restent reconnues : terrain, portée, PM, soin, poussée exacte, dégâts à portée minimale, collision, dégâts centraux ou de dos, statut, cible alignée, bouclier et poussée. [b]Comment fonctionne cet effet ?[/b] affiche unité, cible, condition, durée, fréquence et empilement."],
	]],
	[&"verification", "7 · Tester et analyser", [
		...
		[&"runtime_preview", "Prévisualisation runtime", &"bottom_preview", "Dans [b]Outils > Prévisualiser le sort[/b], le vrai SpellCaster compare base et résultat dans neuf scénarios : défenses 0/25/50/100, allié, ennemi affaibli, dos, cibles multiples et case libre. La sandbox est déterministe et n’écrit rien."],
		[&"full_analysis", "Analyse complète", &"bottom_analysis", "[b]Outils > Analyse complète de l’arbre[/b] énumère les chemins, cherche nœuds inaccessibles et rangs morts, détecte la dominance et examine les choix finaux. Elle aide la conception sans prédire une victoire."],
		[&"compare_runs", "Comparer deux parties", &"compare_runs", "Dans [b]Outils > Comparer deux parties[/b], choisissez la partie de référence. Le rapport compare le profil du héros actif sans changer le contexte ni sauvegarder."],
	...
	[&"safety", "8 · Sauvegarde sûre", [
		...
		[&"orphans", "Resources orphelines", &"orphans", "[b]Outils > Vérifier les Resources orphelines[/b] ouvre leur gestion. [b]Adopter[/b] rattache une discipline. [b]Archiver[/b] retire avec récupération. [b]Supprimer[/b] exige l’identifiant exact et crée aussi une récupération. Une référence entrante bloque les retraits."],
	]],
	[&"readonly", "9 · Non éditable ici", [
		...
		[&"readonly_effect", "Effet : valeurs masquées", &"inspector_effect_advanced", "Le Studio masque les propriétés que le type choisi n’utilise pas, sans effacer leurs anciennes valeurs. Un avertissement signale toute valeur devenue inerte. Pour [b]Déplacement — du lanceur[/b], [b]Exiger un chemin dégagé[/b] reste disponible en mode avancé."],

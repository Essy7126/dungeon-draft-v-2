...
func present(victory: bool, reduced_motion: bool = false) -> void:
	_victory = victory
	var accent_color := (
		Color(0.42, 0.94, 0.72)
		if victory
		else Color(1.0, 0.32, 0.34)
	)
...
func _build_ui() -> void:
	...
	content.custom_minimum_size = Vector2(520.0, 180.0)
	...
	_subtitle.add_theme_color_override("font_color", Color(0.86, 0.89, 0.88))

...
func get_layout_snapshot() -> Dictionary:
	return {
		...
		"active_marker_global": _active_marker.get_global_rect(),
		"active_marker_minimum": _active_marker.get_combined_minimum_size(),
		"xp_global": _xp_label.get_global_rect(),
		"rank_global": _rank_label.get_global_rect(),

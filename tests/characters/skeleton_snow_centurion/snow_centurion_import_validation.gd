class_name SnowCenturionImportValidation
extends Node3D
...
const EXPECTED_ANIMATIONS: Array[StringName] = [
	...
	&"DD_SnowCenturion_Idle",
	&"DD_SnowCenturion_Run",
	&"DD_SnowCenturion_Walk",
]
...
func run_validation() -> Dictionary:
	...
	if mesh_triangles != 3513:
		errors.append("Expected 3513 triangles, got %d" % mesh_triangles)
	if material_count != 1:
